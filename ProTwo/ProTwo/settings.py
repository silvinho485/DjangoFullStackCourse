...
SECRET_KEY = 'aila6h^hq)*o20)6fkgz1xdkug@2cepfc1nw88!q5w%3-ju7d5'
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATES_DIR,], #show templates dir
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/' #Almost like the media, show the static url
STATICFILES_DIRS = [
    STATIC_DIR,
]
